...
public final class LendingModels {
    ...
    /**
     * @param fee origination amount subtracted from present value to produce netAmount; it is not amortized
     * @param installments at most 120 future-value items; amounts are discounted to present value
     */
    ...
    public record ContractResponse(UUID id, String externalReference, String status,
                                   BigDecimal originalPrincipal, BigDecimal fee, BigDecimal netAmount,
                                   String ruleVersion, List<ScheduleItem> schedule) {}
}
